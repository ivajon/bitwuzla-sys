...
mod tests {
    ...
    fn smoke_test() {
        ...
        unsafe {
            ...
            let a_plus_c_gt_b_plus_c =
                bitwuzla_mk_term2(term_manager, BITWUZLA_KIND_BV_SGT, a_plus_c, b_plus_c);
            ...
            bitwuzla_set_option_mode(
                ...
                CString::new("cadical").unwrap().as_ptr(),
            );
            ...
            let a = CStr::from_ptr(bitwuzla_term_value_get_str(bitwuzla_get_value(bzla, a)))
                .to_str()
                .unwrap()
                .to_string();
            let b = CStr::from_ptr(bitwuzla_term_value_get_str(bitwuzla_get_value(bzla, b)))
                .to_str()
                .unwrap()
                .to_string();
            let c = CStr::from_ptr(bitwuzla_term_value_get_str(bitwuzla_get_value(bzla, c)))
                .to_str()
                .unwrap()
                .to_string();
